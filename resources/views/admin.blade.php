                        ...
                        <tr data-id="{{ $usuario->id }}">
                            ...
                            <td>
                                @if($rs_rel && file_exists(storage_path('app/public/' . $rs_rel)))
                                    <a href="{{ asset('storage/' . $rs_rel) }}" target="_blank" rel="noopener"
                                        class="link-primary">Ver archivo</a>
                                @else
                            ...
                            <td>
                                @if($usuario->embarazada)
                                    ...
                                    @if($cg_rel && file_exists(storage_path('app/public/' . $cg_rel)))
                                        <a href="{{ asset('storage/' . $cg_rel) }}" target="_blank" rel="noopener"
                                            class="link-primary">Ver carnet</a>
                                    @else
                                        <span class="text-muted">No hay</span>
                                    @endif
                                @else
            ...
            @foreach($usuarios as $usuario)
                @if($usuario->menores->count() > 0)
                    <div class="tutor-card">
                        <h4>{{ $usuario->nombres }} {{ $usuario->ap_paterno }} {{ $usuario->ap_materno }} <span
                                class="text-muted">({{ $usuario->menores->count() }} menores)</span></h4>
                            ...
                            @foreach($usuario->menores as $menor)
                                ...
                                <div class="menor-card">
                                    ...
                                    <p><strong>Fecha Nac:</strong>
                                        {{ \Carbon\Carbon::parse($menor->fecha_nacimiento)->format('d-m-Y') }}</p>
                                    ...
                                    <p><strong>Carnet Control Sano:</strong>
                                        @if($c_sano_rel && file_exists(storage_path('app/public/' . $c_sano_rel)))
                                            <a href="{{ asset('storage/' . $c_sano_rel) }}" target="_blank" rel="noopener"
                                                class="link-primary">Ver archivo</a>
                                        @else
                                            <span class="text-muted">No hay</span>
                                        @endif
                                    ...
                                    <p><strong>Certificado Nacimiento:</strong>
                                        @if($cert_rel && file_exists(storage_path('app/public/' . $cert_rel)))
                                            <a href="{{ asset('storage/' . $cert_rel) }}" target="_blank" rel="noopener"
                                                class="link-primary">Ver archivo</a>
                                        @else
                                            <span class="text-muted">No hay</span>
                                        @endif
                                    ...
                                    <div class="d-flex gap-2">
                                        <button class="btn btn-primary btn-sm btn-editar-menor" data-bs-toggle="modal"
                                            data-bs-target="#editarMenorModal" data-id="{{ $menor->id }}"
                                            data-nombres="{{ $menor->nombres }}" data-ap_paterno="{{ $menor->ap_paterno }}"
                                            data-ap_materno="{{ $menor->ap_materno }}" data-rut="{{ $menor->rut }}"
                                            data-fecha_nacimiento="{{ $menor->fecha_nacimiento }}"
                                            data-genero="{{ $menor->genero }}">Editar</button>

                                        <button class="btn btn-danger btn-sm btn-eliminar-menor"
                                            data-id="{{ $menor->id }}">Eliminar</button>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label>Nombres</label>
                                    <input type="text" id="editar_nombres" name="nombres" class="form-control" required
                                        maxlength="50">
                                    <div class="invalid-feedback">Solo letras, máximo 50 caracteres.</div>
                                </div>
                                <div class="col-md-6">
                                    <label>Teléfono</label>
                                    <input type="text" id="editar_telefono" name="telefono" class="form-control" required
                                        maxlength="12">
                                    <div class="invalid-feedback">Formato +569XXXXXXXX</div>
                                </div>
                                <div class="col-md-6">
                                    <label>Apellido Paterno</label>
                                    <input type="text" id="editar_ap_paterno" name="ap_paterno" class="form-control"
                                        required maxlength="50">
                                    <div class="invalid-feedback">Solo letras, máximo 50 caracteres.</div>
                                </div>
                                <div class="col-md-6">
                                    <label>Dirección</label>
                                    <input type="text" id="editar_direccion" name="direccion" class="form-control" required
                                        maxlength="50">
                                    <div class="invalid-feedback">Máximo 50 caracteres.</div>
                                </div>
                                <div class="col-md-6">
                                    <label>Apellido Materno</label>
                                    <input type="text" id="editar_ap_materno" name="ap_materno" class="form-control"
                                        required maxlength="50">
                                    <div class="invalid-feedback">Solo letras, máximo 50 caracteres.</div>
                                </div>
                                <div class="col-md-6">
                                    <label>RUT</label>
                                    <input type="text" id="editar_rut" name="rut" class="form-control" required
                                        pattern="^\d{1,2}\.?\d{3}\.?\d{3}-[\dkK]$" maxlength="12">
                        ...
                        <div class="modal-footer"><button type="button" class="btn btn-secondary"
                                ...
                                class="btn btn-primary">Guardar Cambios</button></div>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal fade" id="editarMenorModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <form id="formEditarMenor" method="POST" action="" class="needs-validation" novalidate>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Editar Menor</h5><button type="button" class="btn-close"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label>Nombres</label>
                                    <input type="text" id="editar_menor_nombres" name="nombres" class="form-control"
                                        required maxlength="50">
                                    <div class="invalid-feedback">Solo letras, máximo 50 caracteres.</div>
                                </div>
                                <div class="col-md-6">
                                    <label>Fecha de Nacimiento</label>
                                    <input type="date" id="editar_menor_fecha_nacimiento" name="fecha_nacimiento"
                                        class="form-control" required>
                                    <div class="invalid-feedback">Seleccione fecha válida (0-6 años).</div>
                                </div>
                                <div class="col-md-6">
                                    <label>Apellido Paterno</label>
                                    <input type="text" id="editar_menor_ap_paterno" name="ap_paterno" class="form-control"
                                        required maxlength="50">
                                    <div class="invalid-feedback">Solo letras, máximo 50 caracteres.</div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label>Apellido Materno</label>
                                    <input type="text" id="editar_menor_ap_materno" name="ap_materno" class="form-control"
                                        required maxlength="50">
                                    <div class="invalid-feedback">Solo letras, máximo 50 caracteres.</div>
                                </div>
                                <div class="col-md-6">
                                    <label>RUT</label>
                                    <input type="text" id="editar_menor_rut" name="rut" class="form-control" required
                                        pattern="^\d{1,2}\.?\d{3}\.?\d{3}-[\dkK]$" maxlength="12">
                                    <div class="invalid-feedback">RUT inválido (ej. 12.345.678-9)</div>
                                </div>
                            </div>
